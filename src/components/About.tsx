...
const About = () => {
  return (
    <>
      <SectionDivider variant="curve" height={50} className="translate-y-1" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                About <span className="gradient-text">MM Technology</span>
              </h2>
              <p className="text-foreground/80 mb-6">
                Founded in 2008, MM Technology has been at the forefront of
                technological innovation, helping businesses across industries
                harness the power of technology to drive growth, efficiency, and
                competitive advantage.
              </p>
              <p className="text-foreground/80 mb-8">
                Our team of skilled engineers, designers, and consultants brings
                decades of combined experience to every project, ensuring
                solutions that are not just technically robust but also aligned
