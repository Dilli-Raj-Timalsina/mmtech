    ...
    <section className="relative pt-32 pb-24 overflow-hidden bg-hero-pattern">
      ...
      <div className="container relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p
            className="text-lg md:text-xl text-foreground/80 mb-8 max-w-2xl mx-auto animate-fade-in"
            style={{ animationDelay: "100ms" }}
          >
            MM Technology delivers cutting-edge software development, data
            analytics, and market intelligence solutions that drive innovation
          ...
          >
            <div className="glass-card p-6 rounded-2xl">
              ...
              <p className="text-sm text-foreground/70">
                Tailor-made applications that align perfectly with your business
                needs.
              </p>
            </div>
            ...
            <div className="glass-card p-6 rounded-2xl">
              ...
              <p className="text-sm text-foreground/70">
                Scalable infrastructure and services hosted in secure cloud
                environments.
              </p>
            </div>
