    ...
    >
      <div className="container flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <Link
            to="/"
            className="hover-lift text-foreground/80 hover:text-primary"
          >
            Home
          </Link>
          <Link
        ...
        <div className="hidden md:flex items-center space-x-4">
          <Button
            variant="outline"
            className="text-sm rounded-full px-5 py-2 h-auto"
          >
            Log In
          </Button>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-background border-t absolute top-full left-0 w-full py-4 shadow-lg animate-fade-in">
          <nav className="container flex flex-col space-y-4">
            <Link
              to="/"
              className="text-lg px-3 py-2 hover:bg-muted rounded-md"
